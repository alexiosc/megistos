...
/*
 * $Id: listdownload.c,v 2.0 2004/09/13 19:44:54 alexios Exp $
 *
 * $Log: listdownload.c,v $
...
static const char rcsinfo[] = "$Id: listdownload.c,v 2.0 2004/09/13 19:44:54 alexios Exp $";
