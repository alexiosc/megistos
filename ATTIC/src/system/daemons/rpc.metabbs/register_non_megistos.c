...
/*
 * $Id: register_non_megistos.c,v 2.0 2004/09/13 19:44:53 alexios Exp $
 *
 * $Log: register_non_megistos.c,v $
...
#ifndef RCS_VER 
#define RCS_VER "$Id: register_non_megistos.c,v 2.0 2004/09/13 19:44:53 alexios Exp $"
