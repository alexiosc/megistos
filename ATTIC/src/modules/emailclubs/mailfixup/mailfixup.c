...
/*
 * $Id: mailfixup.c,v 2.0 2004/09/13 19:44:51 alexios Exp $
 *
 * $Log: mailfixup.c,v $
 ...
 * crash.
 *
 * Revision 1.7  2004/05/21 20:19:25  alexios
 * Stopped using bbs:bbs as the UID:GID of our files, moved to using
 * instance UID/GIDs. This is likely to fix various insidious little
 * bugs.
 *
 * Revision 1.6  2004/02/29 18:07:29  alexios
 * Aesthetic fixes.
 *
...
static const char rcsinfo[] = "$Id: mailfixup.c,v 2.0 2004/09/13 19:44:51 alexios Exp $";
...
doindex (char *clubname, char *clubdir)
{
	...
	sprintf (command, "chown -R %d.%d %s 2>/dev/null >/dev/null", bbs_uid, bbs_gid, dir);
	system (command);
