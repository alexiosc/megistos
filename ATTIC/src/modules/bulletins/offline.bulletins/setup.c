...
/*
 * $Id: setup.c,v 2.0 2004/09/13 19:44:50 alexios Exp $
 *
 * $Log: setup.c,v $
...
setup ()
{
	...
	if (dialog_run ("offline.bulletins", OBVT, OBLT, inp_buffer, MAXINPLEN)
	    != 0) {
