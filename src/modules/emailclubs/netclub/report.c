...
/*
 * $Id: report.c,v 2.0 2004/09/13 19:44:51 alexios Exp $
 *
 * $Log: report.c,v $
...
print_report (char *fname, char *sysname)
{
	...
	strftime (tmp, sizeof (tmp), "%a, %d/%b/%Y %H:%M:%S",
		  localtime ((time_t *) & lastsync));
	printf ("Last sync:       %s\n", tmp);
