...
/*
 * $Id: metabbs-server.c,v 2.0 2004/09/13 19:44:54 alexios Exp $
 *
 * $Log: metabbs-server.c,v $
...
static const char rcsinfo[] = "$Id: metabbs-server.c,v 2.0 2004/09/13 19:44:54 alexios Exp $";
