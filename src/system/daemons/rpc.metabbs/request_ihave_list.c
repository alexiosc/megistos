...
/*
 * $Id: request_ihave_list.c,v 2.0 2004/09/13 19:44:53 alexios Exp $
 *
 * $Log: request_ihave_list.c,v $
...
#ifndef RCS_VER 
#define RCS_VER "$Id: request_ihave_list.c,v 2.0 2004/09/13 19:44:53 alexios Exp $"
