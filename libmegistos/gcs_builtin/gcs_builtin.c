...
/*
 * $Id: gcs_builtin.c,v 2.0 2004/09/13 19:44:36 alexios Exp $
 *
 * $Log: gcs_builtin.c,v $
 * Revision 2.0  2004/09/13 19:44:36  alexios
 * Stepped version to recover CVS repository after near-catastrophic disk
 * crash.
 *
 * Revision 1.9  2004/02/29 17:09:48  alexios
 * Changed the bot command's comment (intended for humans).
 *
...
gcs_bot ()
{
	if (!margc)
		...
		if (thisuseronl.flags & OLF_ISBOT) {
			...
			print ("290 There are absolutely no privilege gains in this mode.\n");
		} else {
			mod_setbot (0);
